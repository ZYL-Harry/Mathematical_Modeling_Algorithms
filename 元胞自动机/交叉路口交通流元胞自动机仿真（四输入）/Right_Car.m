function [C,Car,car_number,car_on,judge,flag,aa]=Right_Car(ti,C,Ct,Car,Car_total,car_number,car_on,judge,road_length,flag,light_time,light_gp,aa,rl)
    in_state=3;
    if ti~=1
       %% 根据车辆位置和性质使车辆移动
        ...
        for i=1:size(car_ID,1)   %遍历所有在显示道路上的车辆
            ...
            if judge==0
                [C,Car,aa]=multi_MoveCar(single_car_y,single_car_x,single_car_ID,Car,C,road_length,flag,Car_total,Ct,aa,rl);
            else
                judge=0;
